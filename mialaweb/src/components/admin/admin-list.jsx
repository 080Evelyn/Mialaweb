...
import { adminTableData } from "@/config/adminData";
        ...
        <TableBody className="text-[12px] font-[Raleway] ">
          {adminTableData.map((data, index) => (
            <TableRow key={index}>
              ...
              <TableCell>{data.totalAgents}</TableCell>
                ...
                <Dialog>
                  ...
                  <DialogContent className="sm:max-w-[362px]">
                    ...
                    <div className="flex justify-end gap-2 ">
                      ...
                      <DialogClose
                        type="submit"
                        className="bg-[#153D80] hover:bg-[#153D80]/80 curosor-pointer text-white w-1/2 text-sm rounded-[3px] h-9"
                      >
                        Done
                      </DialogClose>
                    </div>
